...
var _jsxFileName = "C:\\Users\\user\\Desktop\\UDEMY\\NEXT-JS-PROJECTS\\topkovorkStatic\\pages\\_document.js";
  ...
  _createClass(MyDocument, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("html", {
        ...
        src: "https://maps.googleapis.com/maps/api/js?key=".concat(process.env.MAP_KEY, "&libraries=places&language=ru-RU"),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 38
        },
    ...
    value: function getInitialProps(ctx) {
      var renderPage = ctx.renderPage; // Step 1: Create an instance of ServerStyleSheet
      ...
      var session = ctx.req.session; // console.log ( 'DATATAAA> ', html, head, errorHtml, chunks  )
